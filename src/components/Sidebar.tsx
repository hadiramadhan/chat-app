        ...
        {!isCollapsed && (
            <div className="flex justify-between p-2 items-center">
                <div className="flex gap-2 items-center text-2xl">
                    <p className="text-2xl font-bold text-blue-800">Chat <span className="text-green-500 font-bold">App</span></p>
                </div>
            </div>
        )}
        <ScrollArea className="gap-2 px-2 group-[[data-collapsed=true]]:justify-center group-[[data-collapsed=true]]:px-2">
            {users.map((user,idx) => (
                isCollapsed ? (
                    ...
                    variant={"grey"}
                    size="xl"
                    className={cn("w-full justify-start gap-5 my-1", selectedUser?.email === user.email && 
